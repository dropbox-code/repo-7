...
describe('Spacing token tests', () => {
  ...
  it('should not throw as it uses a function', async () => {
    const {
      ...
      code: '@import "~bpk-mixins/index"; a { height: calc(#{$bpk-spacing-lg} - 1px); font-size: 14rem; }',
      config,
    });
  ...
  it('should pass when using custom variable', async () => {
    const {
      ...
      code: '@import "~bpk-mixins/index"; $width-val:5rem a { width: $width-val; font-size: 14rem; }',
      config,
    });
...
describe('Radii token tests', () => {
  ...
  it('should throw an error when a function is used', async () => {
    const {
      ...
      code: '@import "~bpk-mixins/index"; a { border-radius: calc(#{$bpk-border-radius-sm} - 1px); font-size: 14rem; }',
      config,
    });
  ...
  it('throws an error when using raw number', async () => {
    const {
      ...
      code: '@import "~bpk-mixins/index"; a { border-radius: 5rem; font-size: 14rem; }',
      config,
    });
  ...
  it('should pass when using custom variable', async () => {
    const {
      ...
      code: '@import "~bpk-mixins/index"; $radius-val:5rem a { border-radius: $radius-val; font-size: 14rem; }',
      config,
    });
...
describe('Border token tests', () => {
  ...
  it('should throw as it uses a function', async () => {
    const {
      ...
      code: '@import "~bpk-mixins/index"; a { border-width: calc(#{$bpk-border-size-sm} - 1px); font-size: 14rem; }',
      config,
    });
  ...
  it('throws an error when using raw number', async () => {
    const {
      ...
      code: '@import "~bpk-mixins/index"; a { border-width: 5rem; font-size: 14rem; }',
      config,
    });
  ...
  it('throws an error when specifying a number and token', async () => {
    const {
      ...
      code: '@import "~bpk-mixins/index"; a { border-width: 5rem  $bpk-border-size-sm 5rem $bpk-border-size-sm; font-size: 14rem; }',
      config,
    });
  ...
  it('should pass when using custom variable', async () => {
    const {
      ...
      code: '@import "~bpk-mixins/index"; $border-val:5rem a { border-width: $radius-val; font-size: 14rem; }',
      config,
    });
  ...
  it('should pass when using border-top-width', async () => {
    const {
      ...
      code: '@import "~bpk-mixins/index"; { border-top-width: $bpk-border-size-sm; font-size: 14rem; }',
      config,
    });
