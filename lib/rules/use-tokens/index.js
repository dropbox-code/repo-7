...
const rule = (primaryOption, secondaryOptionsObject) => {
  return (postcssRoot, postcssResult) => {
    ...
    postcssRoot.walkDecls(decl => {
      ...
      // TODO: Work out how we test if the value is an expression
      // root.walk(node => {
      //   // if (isNonZeroNumber) {
      //   //   message = `Don't use raw numbers for \`${prop}\` instead use a Backpack token or multiples of a token`;
      //   // }
      // });
